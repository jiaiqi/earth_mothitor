        ...
        <!-- 数据目录服务导航栏 -->
          ...
          >
            ...
            <div style="display: flex">
              <div class="menuItem">
                <el-menu-item index="3-1" @click="toPath2('/service/seismometry',1)">
                  <div @mouseenter="closeAllExpand">测震</div>
                </el-menu-item>
                <el-menu-item
                  index="3-2"
                  @click="toPath2('/service/catalogue',1)"
                >
                  强震动
                </el-menu-item>
                ...
                <el-menu-item
                  index="3-4"
                  @click="toPath2('/service/scientific',1)"
                >
                  科学台阵
                </el-menu-item>
                <el-menu-item
                  index="3-5"
                  @click="toPath2('/service/simulation',1)"
                >
                  模拟资料
                </el-menu-item>
              </div>
              <div class="expand" v-if="showWLExpand">
                ...
                <div
                  class="expandItem"
                  @click="toPath2('/precursor/fluid',1)"
                ...
                <div
                  class="expandItem"
                  @click="toPath2('/precursor/electromagnetism',1)"
                  @mouseenter="showXBExpand = false"
                >
                  电磁
                </div>
                <div
                  class="expandItem"
                  @click="toPath2('/precursor/gravity',1)"
                  @mouseenter="showXBExpand = false"
                >
                  重力
                </div>
                <div
                  class="expandItem"
                  @click="toPath2('/precursor/gnss',1)"
                  @mouseenter="showXBExpand = false"
                >
                  GNSS
                </div>
              ...
              <div class="expand" v-if="showXBExpand">
                <div class="expandItem" @click="toPath2('/precursor/crust',1)">
                  定点形变
                </div>
                <div class="expandItem" @click="toPath2('/precursor/flowMation',1)">
                  流动形变
                </div>
              </div>
            </div>
          </el-submenu>
          <el-menu-item index="2" v-if="type == 0" @click="toPath2('/prevention/catalogue',0)">
            震防数据
          </el-menu-item>
          <el-menu-item index="3" v-if="type == 0" @click="toPath2('/prevention/prospecting',0)">
            探测数据
          </el-menu-item>
          <el-menu-item index="4" v-if="type == 0" @click="toPath2('productlist',1)">
            调查数据
          </el-menu-item>
          <el-menu-item index="5" v-if="type == 0" @click="toPath2('productlist',1)">
            实验数据
          </el-menu-item>
          <el-menu-item index="6" v-if="type == 0" @click="toPath2('productlist',1)">
            专题数据
          </el-menu-item>
          <el-menu-item index="7" v-if="type == 0" @click="toPath2('productlist',1)">
            综合数据
          </el-menu-item>
          ...
          >
            <template slot="title">
              <div @mouseenter="closeAllExpand">地球物理</div>
            </template>
            <div style="display: flex">
              <div class="menuItem">
                ...
                <el-menu-item
                  index="3-2"
                  @click="toPath('precursorProspecting')"
                >
                <div
                    @mouseenter="showXBExpand = false"
                  >
                ...
                <el-menu-item index="3-3" @click="toPath('precursorFluid')">
                  <div
                    @mouseenter="showXBExpand = false"
                  >
                    电磁
