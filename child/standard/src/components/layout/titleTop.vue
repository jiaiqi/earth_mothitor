    ...
    <div class="title">
      <div class="title_tab commom">
        ...
        >
          ...
          <el-menu-item index="/industry">地震灾害防御</el-menu-item>
          <el-menu-item index="/local">地震应急救援</el-menu-item>
          <el-menu-item index="/disaster">震后救灾与重建</el-menu-item>
          <el-menu-item index="/prevention">防震减灾管理</el-menu-item>
        </el-menu>
      </div>
    </div>
  </div>
