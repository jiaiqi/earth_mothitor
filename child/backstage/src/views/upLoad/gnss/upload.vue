  ...
  export default {
    ...
    data() {
      return {
        ...
        model:[
          {
            name: 'GNSS连续站基础数据目录 -陕西_1689669737092.xlsx',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=GNSS连续站基础数据目录 -陕西_1689669737092.xlsx',
          }
        ],
        form: {
    ...
    created() {
      ...
      this.uploadUrl = process.env.VUE_APP_DIREC_API + '/auditserver/gnss/gnssUpload?creator='+this.$store.state.user.name
      //超级管理员
