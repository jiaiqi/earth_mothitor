    ...
    <div class="app-container">
        ...
        <div>
          ...
          >
            ...
            <el-table-column prop="region" width="100" label="区域" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="projectName" width="100" label="所属项目名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="lineName" width="200" label="测线名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="linkMan" label="联系人" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="tel" width="100" label="联系电话" :show-overflow-tooltip="true"></el-table-column>
...
//   import { quickAdd } from "@/api/workflow/audit";
  import { getListWithTaskDeep } from '@/api/workflow/audit.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        upradioType: '',
        // 文件上传地址
        action: process.env.VUE_APP_DIREC_API + '/auditserver/deep_reflection/deepReflectionUpload',
        //选项卡变量
        activeName: 'netWork',
        //台站数据列表
        stationData: [],
    ...
    created() {
      ...
      this.uploadUrl = process.env.VUE_APP_DIREC_API + '/auditserver/dr/deepReflectionUpload?creator='+this.$store.state.user.name
      //超级管理员
    ...
    methods: {
      ...
      getAuditInfo(page) {
        ...
        getListWithTaskDeep(par).then(res=>{
            this.loading = false
