    ...
    <div class="app-container">
        ...
        <div>
          <el-table
            ...
            stripe
          >
            <el-table-column prop="disciplineName" label="所属数据目录名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="describe" label="摘要描述" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="offerUnit" width="120" label="提供单位" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="course" width="100" label="处理过程" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="staName" width="100" label="台站名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="staCode" width="100" label="台站代码" :show-overflow-tooltip="true"></el-table-column>
            ...
            <template slot-scope="scope">
              <el-button 
                ...
                v-hasPermi="['upLoad:vibration:upload']"
              >详情</el-button>
            </template>
          </el-table-column>
          </el-table>
        ...
        <el-dialog title="详情" :visible.sync="open" @close="open = false" width="800px" append-to-body>
          ...
          <el-row>
            ...
            <el-col :span="20">
              <el-form-item label="摘要描述" prop="describe">
                {{ form.describe }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
            ...
            <el-col :span="20">
              <el-form-item label="强震计类型" prop="insType">
                {{ form.insType }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
              <el-form-item label="强震计型号" prop="insModel">
                {{ form.insModel }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
            ...
            <el-col :span="20">
              <el-form-item label="安全限制分级" prop="safetyGrading">
                {{ form.safetyGrading }}
             </el-form-item>
            </el-col>
            </el-row>
...
//   import { quickAdd } from "@/api/workflow/audit";
  import { getListWithTaskStrong } from '@/api/workflow/audit.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        model:[
          {
            name: '2-强震连续观测原始数据目录-广东_1689671758556.xlsx',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=2-强震连续观测原始数据目录-广东_1689671758556.xlsx',
          }
        ],
        form: {
        ...
        upradioType: '',
        // 文件上传地址
        action: process.env.VUE_APP_DIREC_API + '/strongShock/strongShockUpload',
        //选项卡变量
        activeName: 'netWork',
        //台站数据列表
        stationData: [],
    ...
    created() {
      ...
      // this.filterNet()
      this.getAuditInfo({page:1,limit:15})
      this.uploadUrl = process.env.VUE_APP_DIREC_API + '/auditserver/strongShock/strongShockUpload?creator='+this.$store.state.user.name
    },
    methods: {
      /** 查询上报单位 */
      getList() {
      ...
      getAuditInfo(page) {
        ...
        getListWithTaskStrong(par).then(res=>{
            this.loading = false
