<template>
        ...
        <div>
          ...
          >
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item>
                    <el-button 
                      ...
                      v-hasPermi="['upLoad:vibration:expand']"
                    >解析文件</el-button>
                  </el-dropdown-item>
                  <el-dropdown-item>
                    <el-button
            ...
            <el-button
                ...
                v-hasPermi="['upLoad:vibration:audit']"
            >提交审核</el-button>
            <el-button
              style="font-size: 14px;padding: 0px 3px;"
              v-if="scope.row.auditState != 0"
          ...
          >撤销分发</el-button>
            <el-button 
                ...
                v-hasPermi="['upLoad:vibration:delete']"
            >删除</el-button>
            </template>
          </el-table-column>
          </el-table>
  ...
  import { expandExcel, findByFileId, delByFileId } from '@/api/dataup/vibration.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        model:[
          {
            name: '强震模板数据_1690599522125.xlsx',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=强震模板数据_1690599522125.xlsx',
          }
        ],
        form: {
