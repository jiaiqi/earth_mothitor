      ...
      <div>
        ...
        >
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <el-button 
                    ...
                    v-hasPermi="['upLoad:seismometry:expand']"
                  >解析文件</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button
          ...
          <el-button
              ...
              v-hasPermi="['upLoad:seismometry:audit']"
          >提交审核</el-button>
          <el-button
              style="font-size: 14px;padding: 0px 3px;"
              v-if="scope.row.auditState != 0"
          ...
          <el-button 
            ...
            v-if="scope.row.auditState <= 0"
              ...
              v-hasPermi="['upLoad:seismometry:delete']"
          >删除</el-button>
          </template>
        </el-table-column>
        </el-table>
        ...
        <el-row>
          ...
          <el-col :span="20">
            <el-form-item label="建站时间" prop="cTime">
              {{ new Date(form.cTime).toLocaleDateString() }}
           </el-form-item>
          </el-col>
          <el-col :span="20">
...
import { seiAnaly, seiGetTaskId, seiFindByFileId, seiDelByFileId } from '@/api/workflow/selsmometry.js'
...
export default {
  ...
  data() {
    return {
      ...
      model:[
        {
          name: '测震模版-连续观测',
          url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=测震模版-连续观测_1692128936787.xlsx'
        }
      ],
      form: {
  ...
  methods: {
    ...
    expandResult(item) {
      ...
      this.loading = true
      seiFindByFileId(encode(par)).then(res=>{
    ...
    delExpandFile() {
      ...
      this.$modal
        ...
        .then(() => {
          this.loading = true
          return seiDelByFileId(encode(par))
        })
        .then(() => {
          self.loading = false
          self.open4 = false
