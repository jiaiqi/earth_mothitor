<template>
        ...
        <div>
          ...
          >
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item>
                    <el-button 
                      ...
                      v-hasPermi="['upLoad:geological:expand']"
                    >解析文件</el-button>
                  </el-dropdown-item>
                  <el-dropdown-item>
                    <el-button
            ...
            <el-button
                ...
                v-hasPermi="['upLoad:geological:audit']"
            >提交审核</el-button>
            <el-button
                style="font-size: 14px;padding: 0px 3px;"
                v-if="scope.row.auditState != 0"
          ...
          >撤销分发</el-button>
            <el-button 
               ...
               v-if="scope.row.auditState <= 0"
                ...
                v-hasPermi="['upLoad:geological:delete']"
            >删除</el-button>
            </template>
          </el-table-column>
          </el-table>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
              <template slot-scope="scope">
                <el-button 
                  ...
                  v-hasPermi="['upLoad:geological:auditFileList']"
                >详情</el-button>
              </template>
            </el-table-column>
            </el-table>
  ...
  import { expandExcel, findByFileId, delByFileId } from '@/api/workflow/underFluid.js'
    ...
    data() {
      return {
        ...
        model:[
          {
            name: '地质剖面-广东',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=地质剖面-广东_1692302227812.xlsx',
          }
        ],
        form: {
