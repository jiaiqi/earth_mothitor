    ...
    <div class="app-container">
        ...
        <div>
          <el-table
            ...
            stripe
          >
            <el-table-column prop="dataCatalog" label="所属数据目录名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="descriptions" label="摘要描述" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="distributionDepartment" width="120" label="提供单位" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="processingProcess" width="100" label="处理过程" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="projectName" width="250" label="所属项目名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="distributionDepartment" width="200" label="分发单位" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="personToContact" width="100" label="联系人" :show-overflow-tooltip="true"></el-table-column>
            ...
            <template slot-scope="scope">
              <el-button 
                ...
                v-hasPermi="['upLoad:geological:index']"
              >详情</el-button>
            </template>
          </el-table-column>
          </el-table>
        ...
        <el-dialog title="详情" :visible.sync="open" @close="open = false" width="800px" append-to-body>
          ...
          <el-row>
            <el-col :span="20">
              <el-form-item label="所属数据目录名称" prop="dataCatalog">
                {{ form.dataCatalog }}
              </el-form-item>
            </el-col>
            <el-col :span="20">
            ...
            <el-col :span="20">
              <el-form-item label="数据目录提供单位" prop="distributionDepartment">
            ...
            <el-col :span="20">
              <el-form-item label="调查点名称" prop="surveySiteName">
                {{ form.surveySiteName }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
              <el-form-item label="镜像" prop="mirrorImage">
                {{ form.mirrorImage }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
              <el-form-item label="调查点经度(°)" prop="longitude">
                {{ form.longitude }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
              <el-form-item label="调查点纬度（°）" prop="latitude">
                {{ form.latitude }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
              <el-form-item label="调查点内容" prop="surveyContent">
                {{ form.surveyContent }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
...
//   import { quickAdd } from "@/api/workflow/audit";
  import { getListWithTaskGeological } from '@/api/workflow/audit.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        model:[
          {
            name: '地质剖面-广东_1689677246039.xlsx',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=地质剖面-广东_1689677246039.xlsx',
          }
        ],
        pages: {
          pageNum: 1,
        ...
        upradioType: '',
        // 文件上传地址
        action: process.env.VUE_APP_DIREC_API + '/auditserver/geologicalSection/geologicalSectionUpload',
        //选项卡变量
        activeName: 'netWork',
        //台站数据列表
        stationData: [],
    ...
    created() {
      ...
      this.uploadUrl = process.env.VUE_APP_DIREC_API + '/auditserver/geologicalSection/geologicalSectionUpload?creator='+this.$store.state.user.name
    },
    methods: {
      /** 查询上报单位 */
      getList() {
      ...
      getAuditInfo(page) {
        if(this.taskId){
          ...
          getListWithTaskGeological(par).then(res=>{
            this.loading = false
