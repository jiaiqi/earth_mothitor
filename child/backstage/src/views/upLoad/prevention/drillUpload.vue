  ...
  <div class="app-container">
      ...
      <div>
        ...
        >
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <el-button 
                    ...
                    v-hasPermi="['upLoad:prevention:drillUpload:expand']"
                  >解析文件</el-button>
                </el-dropdown-item>
                <el-dropdown-item>
                  <el-button
          ...
          <el-button
              ...
              v-hasPermi="['upLoad:prevention:drillUpload:audit']"
          >提交审核</el-button>
          <el-button
                style="font-size: 14px;padding: 0px 3px;"
          ...
          <el-button 
            ...
            v-if="scope.row.auditState <= 0"
              ...
              v-hasPermi="['upLoad:prevention:drillUpload:delete']"
          >删除</el-button>
          </template>
        </el-table-column>
        </el-table>
      ...
      <el-dialog title="解析结果" :visible.sync="open4" @close="open4 = false" width="1300px" append-to-body>
        ...
        >
          ...
          <el-table-column prop="providerUnit" width="120" label="提供单位" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="treatingProcesses" width="100" label="处理过程" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="distributionDepartment" label="分发单位" :show-overflow-tooltip="true"></el-table-column>
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button 
                ...
                v-hasPermi="['upLoad:prevention:drillUpload']"
              >详情</el-button>
            </template>
          </el-table-column>
          </el-table>
        ...
        <div v-show="mode == '点'">
          ...
          stripe
        >
          <el-table-column prop="lineName" label="浅层地震勘察线路名称" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="pointCode" label="炮点编号" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="lon"  label="钻孔点经度(°)" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="lat"  label="钻孔点纬度(°)" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="coordinateSystem" label="坐标系" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button 
                size="mini"
      ...
      <el-dialog title="详情" :visible.sync="open" @close="open = false" width="800px" append-to-body>
        ...
        <el-row>
          <el-col :span="20">
            ...
            <el-col :span="20">
              <el-form-item label="测线名称" prop="profileName">
                {{ form.profileName }}
             </el-form-item>
            </el-col>
            <el-col :span="20">
      ...
      <el-dialog title="详情" :visible.sync="open2" @close="open2 = false" width="800px" append-to-body>
        ...
        <el-row>
          <el-col :span="20">
            <el-form-item label="浅层地震勘察线路名称" prop="lineName">
              {{ form.lineName }}
            </el-form-item>
          </el-col>
          <el-col :span="20">
            <el-form-item label="炮点编号" prop="pointCode">
              {{ form.pointCode }}
           </el-form-item>
          </el-col>
          <el-col :span="20">
            <el-form-item label="测点标高（m）" prop="heigh">
              {{ form.heigh }}
           </el-form-item>
          </el-col>
          <el-col :span="20">
...
import { drillAnaly, drillGetTaskId, drillFindByFileId, drillDelByFileId } from '@/api/dataup/probedata.js'
import { excelfileList, excelCreate, excelRemove, excelUpdate, setAuditState, getAuditLog, pushData } from '@/api/dataup/criterion.js'
...
export default {
  ...
  data() {
    return {
      ...
      model:[
        {
          name: '人工地震勘探-模版_1692012415014.xlsx',
          url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=人工地震勘探-模版_1692012415014.xlsx',
        }
      ],
      form: {
  ...
  methods: {
    ...
    toExpandExcel(item) {
      ...
      this.loading = true
      drillAnaly(encode(par)).then(res=>{
        if(res == '解析成功'){
          //解析后，修改为已解析状态
          let p = {
            id: item.id,
    ...
    expandResult(item) {
      ...
      this.loading = true
      drillFindByFileId(encode(par)).then(res=>{
    ...
    delExpandFile() {
      ...
      this.$modal
        ...
        .then(() => {
          this.loading = true
          return drillDelByFileId(encode(par))
        })
        .then(() => {
          self.loading = false
          self.open4 = false
