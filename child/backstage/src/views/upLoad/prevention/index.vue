    ...
    <div class="app-container">
        ...
        <div>
          ...
          >
            ...
            <el-table-column prop="profileName" width="200" label="测线名称" :show-overflow-tooltip="true"></el-table-column>
...
//   import { quickAdd } from "@/api/workflow/audit";
  import { getListWithTaskActiveFault } from '@/api/workflow/audit.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        model:[
          {
            name: '人工地震勘探-广东_1689675240482.xlsx',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=人工地震勘探-广东_1689675240482.xlsx',
          },
          {
            name: '钻孔联合剖面-广东_1689675299200.xlsx',
            url: 'http://www.earthquake.ac.cn/prodSer/downloadImage/?filename=钻孔联合剖面-广东_1689675299200.xlsx',
          }
        ],
        total: 0,
        form: {
        ...
        upradioType: '',
        // 文件上传地址
        action: process.env.VUE_APP_DIREC_API + '/auditserver/activeFault/activeFaultUpload',
        //选项卡变量
        activeName: 'netWork',
        //台站数据列表
        stationData: [],
    ...
    created() {
      ...
      this.uploadUrl = process.env.VUE_APP_DIREC_API + '/auditserver/activeFault/activeFaultUpload'
    },
    methods: {
      /** 查询上报单位 */
      getList() {
      ...
      getAuditInfo(page) {
        if(this.taskId){
          ...
          getListWithTaskActiveFault(par).then(res=>{
            this.loading = false
