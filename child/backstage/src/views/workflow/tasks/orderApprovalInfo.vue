<template>
  <div class="app-container fauit">
    <i v-if="showIfr" class="el-icon-error" style="z-index:1200;font-size:26px;position: relative;top: 50px;left:88%;width: 50px;height: 50px;" @click="close"></i>
    <div v-if="showIfr" class="iframe">
      <iframe :src="previewUrl" width="900" height="600"></iframe>
    </div>
    <div>
