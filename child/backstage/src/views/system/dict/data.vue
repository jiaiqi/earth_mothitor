...
import { optionselect as getDictOptionselect, listType } from "@/api/system/dict/type"
  ...
  methods: {
    ...
    getList(dictType) {
      listData({ dictType: dictType }).then(response => {
        ...
        this.queryParams.dictType = response.rows.dictType
        this.defaultDictType = response.rows.dictType
        this.loading = false
      })
    },
    // /** 查询字典类型列表 */
