...
const service = axios.create({
  ...
  // baseURL: process.env.VUE_APP_DFT_API,
  baseURL: location.hostname == 'localhost' || location.hostname == '192.168.0.127' ? process.env.VUE_APP_DFT_API.replace('9530','9546') : '',
  // 超时
  timeout: 10000
})
  ...
  (res) => {
    ...
    if (code === 401) {
      MessageBox.confirm(
        ...
        .then(() => {
          // window.microApp && window.microApp.dispatch({ route: 'index' })
          location.href = '/home?relog=true'
