    ...
    <div class="title">
      <div class="title_tab commom">
        <el-menu
          ...
          :unique-opened="true"
          >
          <el-menu-item index="1" @click="toPath3('/home',1)">首页</el-menu-item>
          <el-submenu index="2" :popper-append-to-body="false">
           <template slot="title">形变</template>
           <el-menu-item index="/crust">定点形变</el-menu-item>
           <el-menu-item index="/flowmation">流动形变</el-menu-item>
           </el-submenu>
           <el-menu-item index="/fluid">流体</el-menu-item>
           <el-menu-item index="/electromagnetism">电磁</el-menu-item>

          <el-menu-item index="/gravity">重力</el-menu-item>

           <el-menu-item index="/gnss">GNSS</el-menu-item>
          <!-- <el-menu-item index="/catalogue">地震遥感</el-menu-item> -->
        </el-menu>
      </div>
    </div>
  </div>
