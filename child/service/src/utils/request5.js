...
const service = axios.create({
  ...
  // baseURL: process.env.VUE_APP_SIMUL_API,
  baseURL: location.hostname == 'localhost' || location.hostname == '192.168.0.127' ? process.env.VUE_APP_SIMUL_API.replace('9531','9549') : '',
  // 超时
  timeout: 10000
})
    ...
    if (code === 401) {
      MessageBox.confirm(
        ...
        .then(() => {
          ...
          // let name = 'index'
          // window.microApp &&
          //   window.microApp.dispatch({ route: { name }, auto: 'layout' })
