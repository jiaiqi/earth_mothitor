    ...
    <div class="title">
      <div class="title_tab commom">
        <el-menu
          ...
          :unique-opened="true"
        >
          <el-menu-item index="/science">震源物理实验</el-menu-item>
          <el-menu-item index="/knowledge">构造物理实验</el-menu-item>
          <el-menu-item index="/dating">新构造年代测试</el-menu-item>
          <el-menu-item index="/experiment">岩石力学实验</el-menu-item>
          <el-menu-item index="/structural">结构抗震实验</el-menu-item>
        </el-menu>
      </div>
    </div>
  </div>
