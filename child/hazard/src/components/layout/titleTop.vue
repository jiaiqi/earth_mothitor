    ...
    <div class="title">
      <div class="title_tab commom">
        <el-menu
          ...
          :unique-opened="true"
        >
          <el-menu-item index="/seismogeology">地震地质</el-menu-item>
          <el-menu-item index="/retrieval">地震现场调查</el-menu-item>
          <el-menu-item index="/fault">历史地震资料</el-menu-item>
        </el-menu>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    route() {
      ...
      window.open(`${url}`, [token, home]) // 新窗口打开
    },
    // 下拉菜单显示隐藏
    showDrop(e) {
      if (e === false) {
